  ...
  return (
    <div className="bg-grayLight">
      ...
      <div className=" p-12 relative">
        ...
        <p className="text-center max-w-[1100px] m-auto mt-20 text-whiteGray text-lg">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus
          eveniet accusamus a sapiente, cupiditate libero exercitationem,
          eligendi voluptatem ipsum minima officia
        </p>
      </div>
