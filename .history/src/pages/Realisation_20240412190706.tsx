    ...
    return (
        <div className="bg-grayLight">
            ...
            <div className=" p-12 relative">
                <h1 className="mt-10 text-center text-6xl text-white">Nos Réalisations</h1>
            <p className="text-center max-w-[1100px] m-auto mt-20 text-whiteGray text-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus eveniet accusamus a sapiente, cupiditate libero exercitationem, eligendi voluptatem ipsum minima officia</p>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-3 mt-10 lg:grid-cols-4 gap-4 md:gap-8 pl-3 pr-3 md:pl-10 md:pr-10 pb-32 max-w-[1700px] m-auto ">
                {
                    ScreenShotSite.map((site , index)=>(
                        <div className={`relative group rounded-3xl overflow-hidden shadow-xl mt-5 shadow-[rgba(0,0,0,0.3)]`}  key={`site numéro : ${index}`}>
