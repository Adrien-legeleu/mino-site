  ...
  return (
    <div className="relative h-11 w-full min-w-[200px] z-10">
      ...
      <div
        ...
        }  duration-200 max-h-[200px] overflow-y-scroll bg-grayDark lg:rounded-3xl  rounded-2xl flex flex-col gap-5`}
      ...
      >
        {OptionsSelect.map((option, index) => {
          return (
            <div
              key={index}
              className="bg-white z-50 text-white flex flex-col h-[100px]"
