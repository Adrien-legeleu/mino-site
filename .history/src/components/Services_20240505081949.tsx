...
const Services = () => {
  ...
  useEffect(() => {
    // Créez d'abord le défilement en douceur !
    smoother.current = ScrollSmoother.create({
      smooth: 2, // secondes nécessaires pour "rattraper" la position de défilement native
      effects: true, // recherche les attributs de données de vitesse et de décalage sur les éléments et anime en conséquence
    });
