        ...
        >
          {servicesInfos.map((serviceInfo, index) => (
            <div
              ...
              className="p-3  flex flex-col gap-5 justify-between h-full items-center"
            >
              <div className="bg-[rgba(30,30,30,0.4)] lg:rounded-3xl rounded-2xl w-full flex items-center justify-center relative pt-3 pb-3 ">
                <img
                  src={serviceInfo.img}
