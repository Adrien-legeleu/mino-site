  ...
  return (
    <div className="h-full w-full bg-grayLight pt-48 pb-48 max-w-[1700px] m-auto">
      ...
      <div className=" flex flex-col lg:grid lg:grid-cols-30/70 mt-16">
        ...
        <div
          className="relative grid-cols-1  grid  gap-12 w-[80%] justify-end items-end"
          id="service"
        >
          {servicesData.map((data, index) => {
            return (
              ...
              >
                ...
                <div className="grid grid-cols-30/70 gap-4 md:gap-8 group-hover:translate-x-5 duration-500 ease-in-out z-10 items-center">
