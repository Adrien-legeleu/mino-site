            ...
            {Cards.map((card, index) => (
              <SplideSlide>
                ...
                >
                  ...
                  <div className=" bg-[rgba(30,30,30,0.4)] absolute top-2 right-2  lg:rounded-3xl rounded-2xl h-[50%]  sm:h-[70%] xl:h-[60%] 2xl:h-[80%] w-1/2 flex items-center justify-center  m-auto">
                    <img
                      className="duration-300 ease-out w-[50%]  object-contain"
                      src={card.img}
                      alt={card.title}
