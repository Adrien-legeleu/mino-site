        ...
        {window.innerWidth > 768 ? (
          <div className="flex flex-col gap-6">
            {Cards.map((card, index) => (
              <div
                key={index}
                className="relative grid grid-cols-30/70 bg-grayDark rounded-3xl h-[200px] sease-out duration-300 group"
              >
                <div className=" bg-[rgba(30,30,30,0.4)]   lg:rounded-3xl rounded-2xl h-[50%] sm:h-[70%] xl:h-[80%] 2xl:h-[95%] w-full flex items-center justify-center   top-1/2 -translate-y-1/2 relative right-10">
                  <img
