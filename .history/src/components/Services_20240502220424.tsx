      ...
      <div className=" flex flex-col lg:grid lg:grid-cols-30/70 mt-16">
        ...
        >
          {servicesData.map((data, index) => {
            return (
              <div
                className="grid grid-cols-80/20 gap-2  h-48 w-full bg-grayDark justify-center rounded-3xl group relative mb-4"
              ...
              >
                ...
                <div className="grid grid-cols-80/20 gap-4 md:gap-8 group-hover:translate-x-5 duration-500 ease-in-out items-center">
                  <div className="bg-[rgba(30,30,30,0.4)] lg:rounded-3xl rounded-2xl h-full w-full flex items-center justify-center ">
                    <img
                      className="w-[95%] lg:rounded-3xl rounded-2xl"
                      src={data.src}
                      alt={`icon : ${index}`}
                    />
                  </div>
