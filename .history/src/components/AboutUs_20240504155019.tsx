              ...
              <SplideSlide>
                ...
                >
                  <div className="flex flex-col justify-between p-5 pb-7   h-full">
                    ...
                    <p className="text-whiteGray  text-[0.7rem] sm:text-[0.75rem]">
                      {card.text}
                    </p>
                  </div>
                  <div className=" bg-[rgba(30,30,30,0.4)] absolute top-5 right-2  lg:rounded-3xl rounded-2xl h-20 w-20 flex items-center justify-center  m-auto">
                    <img
                      className="duration-300 ease-out w-[50%]  object-contain"
                      src={card.img}
                      alt={card.title}
