                ...
                >
                  ...
                  <div className="grid grid-cols-60/40 gap-4 md:gap-8 group-hover:translate-x-5 duration-500 ease-in-out items-center">
                    <div className="h-[80%] w-[90%] flex items-center justify-center ">
                      <img
                        className="w-[100%] h-[70%] md:h-full lg:rounded-3xl rounded-2xl"
                        src={data.src}
                        alt={`icon : ${index}`}
                      />
                    </div>
                  ...
                  <div className="flex items-center justify-end z-10">
                    <button
                      className="bg-green md:pt-3 py-1 md:pb-3 pl-2 pr-2 md:pr-5 md:pl-5 rounded-full lg:opacity-0 lg:translate-y-12 group-hover:opacity-100 group-hover:translate-y-0 duration-500 ease-in-out hover:brightness-90 hover:scale-110 "
