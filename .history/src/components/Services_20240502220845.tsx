      ...
      <div className=" flex flex-col lg:grid lg:grid-cols-30/70 mt-16">
        ...
        >
          {servicesData.map((data, index) => {
            return (
              <div
                className="grid grid-cols-95/5 gap-2  h-48 w-full pl-5 pr-5 bg-grayDark justify-center rounded-3xl group relative mb-4"
              ...
              >
                ...
                <div className="grid grid-cols-80/20 gap-4 md:gap-32 group-hover:translate-x-5 duration-500 ease-in-out items-center">
