        ...
        <div className="hidden bg-grayDark rounded-3xl lg:flex lg:flex-col items-center w-1/2 m-auto justify-center gap-10">
          {servicesInfos.map((serviceInfo, index) => (
            <div
              ...
              className="p-5 flex flex-col gap-5 justify-between h-full"
            >
              <div className="bg-[rgba(30,30,30,0.4)] lg:rounded-3xl h-screen  w-full flex items-center justify-center relative">
                <img
                  src={serviceInfo.img}
                  alt={serviceInfo.title}
                  className={`w-[10%] object-contain relative`}
                />
              </div>
