        ...
        {window.innerWidth > 768 ? (
          <div className="flex flex-col gap-6">
            {Cards.map((card, index) => (
              <div
                key={index}
                className="grid grid-cols-30/70 bg-grayDark rounded-3xl h-[200px] items-center justify-center sease-out duration-300 group relative"
              >
                <div className=" bg-[rgba(30,30,30,0.4)]   lg:rounded-3xl rounded-2xl h-[50%]  sm:h-[70%] xl:h-[60%] 2xl:h-[80%] w-1/2 flex items-center justify-center relative">
                  <img
