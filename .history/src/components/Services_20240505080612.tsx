    ...
    <div className="h-full w-full bg-grayLight pt-48 pb-48 max-w-[1700px] m-auto ">
      ...
      >
        <div className=" w-full h-full relative services">
          <div
            className={`flex  bg-grayDark rounded-3xl fixed  h-screen lg:flex lg:flex-col w-[150px] items-center scale-90 translate-x-1/2 top-0 left-0 ${isLeftVisible ? "visible " ,"invisible" } `}
            ref={leftRef}
          >
