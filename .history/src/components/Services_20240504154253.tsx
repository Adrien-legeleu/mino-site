              ...
              <a href={data.href}>
                ...
                >
                  ...
                  <div className="flex items-center justify-end z-10">
                    <button
                      className="bg-green md:pt-3 py-1 md:pb-3 px-3 md:pr-5 md:pl-5 rounded-full lg:opacity-0 lg:translate-y-12 group-hover:opacity-100 group-hover:translate-y-0 duration-500 ease-in-out hover:brightness-90 hover:scale-110 "
