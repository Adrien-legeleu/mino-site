...
const Contact = () => {
  ...
  >
    ...
    <div className="flex items-center justify-end z-10">
      <button className="bg-green pt-3 pb-3 pr-5 pl-5 rounded-full opacity-0 translate-y-12 group-hover:opacity-100 group-hover:translate-y-0 duration-500 ease-in-out hover:brightness-90 hover:scale-110 " onClick={()=>setIsVisibleForm(true)}>
        <img
          className="w-4"
    ...
    <Form setIsVisibleForm={setIsVisibleForm} isVisibleForm={isVisibleForm} desc={desc} />
  </div>
))}
...
const contactText = [
  {
    ...
    under_text2:"Écrivez-nous pour prendre contact, nous allons échanger sur votre besoin et le chiffrer.",
    icon:"./icon/file (1).png",
  },
  {
    text: "J'ai besoin de plus d'informations sur Mino.",
    text2: "Des questions à nous poser ?",
    under_text2:"Posez-nous votre question , nous vous répondrons dans le plus de détails",
    icon:"./icon/info.png",
  },
  {
    text: "Votre agence m'intéresse et je souhaite postuler.",
    text2: "Notre agence vous intéresse ?",
    under_text2:"Très bon choix, vous pouvez nous contacter directement ci-dessous.",
    icon:"./icon/user.png",
  },
];
